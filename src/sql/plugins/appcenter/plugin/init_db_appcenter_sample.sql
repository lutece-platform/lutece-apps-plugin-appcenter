...
INSERT INTO appcenter_demand_type ( id, id_demand_type, id_workflow, java_class , label, description, question, id_category_demand_type, n_order ) VALUES
    ...
    (5,'environment',-1,'','Demande d''environnement physique','Ce type de demande enclenche la création de l''environnement physique (ajout de VM)','Avez vous besoin de faire une demande de livraison d''environnement physique ?',2,5),
