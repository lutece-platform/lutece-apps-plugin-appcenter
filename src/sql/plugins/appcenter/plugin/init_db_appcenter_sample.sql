...
INSERT INTO appcenter_demand_type ( id, id_demand_type, label, description, question, id_category_demand_type, n_order ) VALUES
    ...
    (5,'environment','Création de l''environment','Ce type de demande permet d''obtenir les configurations nécessaires afin de créer l''environement applicatif','Votre application a t-elle besoin d''un environnement applicatif ?',2,5),
    (6,'openam','Authentification Front Office','OpenAM est un mode d''authentification qui est notamment utilisé pour authentifier les utilisateurs de la Ville de Paris côté front; dans le cadre de la GRU.','Votre application doit-elle proposer un mode d''authentification "MonCompte" pour l''usager (OpenAM) ?',3,6),
